...
#define GL_CullMode_FACE_MODE                 0x0B45
...
GL_APICALL void         GL_APIENTRY glTexImage2D (GLenum target, GLint level, GLenum internalformat/*目标结构*/, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type/*源结构*/, const void* pixels);
