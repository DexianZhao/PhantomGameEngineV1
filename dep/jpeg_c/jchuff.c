...
LOCAL(void)
jpeg_make_c_derived_tbl (j_compress_ptr cinfo, BoolLean isDC, int tblno,
			 c_derived_tbl ** pdtbl)
{
  JHUFF_TBL *htbl;
  c_derived_tbl *dtbl;
...
finish_pass_gather (j_compress_ptr cinfo)
{
  ...
  jpeg_component_info * compptr;
  JHUFF_TBL **htblptr;
  BoolLean did_dc[NUM_HUFF_TBLS];
  BoolLean did_ac[NUM_HUFF_TBLS];
...
METHODDEF(void)
start_pass_huff (j_compress_ptr cinfo, BoolLean gather_statistics)
{
  huff_entropy_ptr entropy = (huff_entropy_ptr) cinfo->entropy;
  int ci, tbl;
  jpeg_component_info * compptr;
