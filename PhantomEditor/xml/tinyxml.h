...
public:
	...
	*/
	...
	const TIXML_STRING&	GetValue(){return value;}
protected:
...
public:
	...
	void			Enum(std::vector<CXmlValueA>& rets);
...
// OGRE CHANGE
	...
	*/
	...
	void			enumAttrbutes(std::vector<CXmlValueA>& rets){attributeSet.Enum( rets );}
protected:
...
public:
	...
	*/
	bool LoadFromMemory(const char* szText);
	//
	bool LoadFile();
	/// Save a file using the current document value. Returns true if successful.
	bool SaveFile( const char* szHeadText ) const;
	/// Load a file using the given filename. Returns true if successful.
	bool LoadFile( const char * filename );
	/// Save a file using the given filename. Returns true if successful.
	bool SaveFile( const char * filename , const char* szHeadText ) const;
	...
	bool SaveFile( const std::string& filename  , const char* szHeadText ) const		///< STL std::string version.
	{
