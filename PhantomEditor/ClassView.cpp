...
VOID CClassView::SetChildWnd(HWND hWnd, const wchar_t* szName)
{
	if(m_hWndChild)
	{
		::SetParent(m_hWndChild, m_hOldParent);
	...
	if(m_hWndChild)
	{
		m_hOldParent	=	::GetParent(m_hWndChild);
...
void CClassView::AdjustLayout()
{
	...
	if(m_hWndChild)
		::MoveWindow(m_hWndChild, 0, 0, rectClient.Width(), rectClient.Height(), TRUE);
